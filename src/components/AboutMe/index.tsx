        ...
        <div className="m-auto flex flex-col items-center justify-center md:flex-row md:items-start md:justify-between">
          ...
          <div className="bg-background1 p-4 text-white md:w-4/5">
            <p className="text-lg leading-relaxed">
              ...
              crafting immersive digital experiences. I have a proven track
              record of impactful projects across a variety of industries. My
              expertise lies in using cutting-edge technology to create complex
              ...
              integration through flexible frontend solutions. Using
              technologies like React, Redux-Saga, and styled-components, I
              created a unified platform that simplified operations and
